<template>
        <div class="container">
                ...
                <div>
                    ...
                    <div v-if="userInfo != null"><button type="button" class="btn btn-outline-secondary mb-3" style="text-align:right; align-items: right"  @click="moveWrite()">글쓰기</button></div>
                    </div>            
